...
export const messages = {
	ATHENA_SHOULD_BE_IN_WORKSPACE: '"athena" folder should be opened in the workspace',
	ATHENA_SHOULD_BE_CURRENT_FOLDER: 'The file should be inside an "athena" folder',
	COPYRIGHT_ALREADY_UPDATED: 'Copyright already up to date',
	COPYRIGHT_UPDATED: 'Copyright updated',
	NO_COPYRIGHT_INFO: 'No copyright information found',
	PACKAGE_FILTERS_ALREADY_UPDATED: 'Package already added to the build',
